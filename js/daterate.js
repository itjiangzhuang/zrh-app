 ...
 */
(function ($) {      
    $.fn.daterate = function (options,Ycallback,Ncallback) {
        //插件默认选项
        var that = $(this);
        ...
        $.fn.daterate.defaultOptions = {
            beginyear:1,                 //日期--年--份开始
            endyear:30,                   //日期--年--份结束
        ...
        //用户选项覆盖插件默认选项   
        var opts = $.extend( true, {}, $.fn.daterate.defaultOptions, options );
        ...
        function bindButton(){
            ...
            $("#dateconfirm").unbind('click').click(function () {	
			  ...
			  $("#daywrapper ul li:eq("+Math.round(indexD)+")").html().substr(0,$("#daywrapper ul li:eq("+Math.round(indexD)+")").html().length-1)+"%";
                ...
                $('#rateCap').change();
                $('#rateFloor').val(  $("#daywrapper ul li:eq("+Math.round(indexD)+")").html().substr(0,$("#daywrapper ul li:eq("+Math.round(indexD)+")").html().length-1))
                $('#rateFloor').change();
               if(datetime){
        ...
        function CreateDateUI(){
            var str = ''+
                ...
                '<div id="datePage" class="page">'+
                    '<section>'+
                        '<div id="datetitle"><h4>请选择期望利率</h4></div>'+
